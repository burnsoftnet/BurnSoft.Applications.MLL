...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [ConfigListDataMetalicData](./burnsoft.applications.mll.types.configlistdatametalicdata)
...
```csharp
public ConfigListDataMetalicData()
```
