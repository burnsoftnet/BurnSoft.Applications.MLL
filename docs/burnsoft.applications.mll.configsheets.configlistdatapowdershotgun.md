...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [ConfigListDataPowderShotGun](./burnsoft.applications.mll.configsheets.configlistdatapowdershotgun)
...
```csharp
public ConfigListDataPowderShotGun()
```
...
### **Add(String, Int64, Int64, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Boolean, String&)**

Adds the specified database path.

```csharp
public static bool Add(string databasePath, long ConfgNameId, long PowderId, double LoadMin, double LoadMid, double LoadMax, double FpsMin, double FpsMid, double FpsMax, double PsiMin, double PsiMid, double PsiMax, double LupMin, double LupMid, double LupMax, bool isDefault, String& errOut)
```
...
`PsiMin` [Double](https://docs.microsoft.com/en-us/dotnet/api/system.double)<br>
The psi minimum.

`PsiMid` [Double](https://docs.microsoft.com/en-us/dotnet/api/system.double)<br>
The psi mid.

`PsiMax` [Double](https://docs.microsoft.com/en-us/dotnet/api/system.double)<br>
The psi maximum.

`LupMin` [Double](https://docs.microsoft.com/en-us/dotnet/api/system.double)<br>
The lup minimum.

`LupMid` [Double](https://docs.microsoft.com/en-us/dotnet/api/system.double)<br>
The lup mid.

`LupMax` [Double](https://docs.microsoft.com/en-us/dotnet/api/system.double)<br>
The lup maximum.
...
### **Update(String, Int64, Int64, Int64, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Boolean, String&)**

Updates the specified database path.

```csharp
public static bool Update(string databasePath, long id, long ConfgNameId, long PowderId, double LoadMin, double LoadMid, double LoadMax, double FpsMin, double FpsMid, double FpsMax, double PsiMin, double PsiMid, double PsiMax, double LupMin, double LupMid, double LupMax, bool isDefault, String& errOut)
```
