...
Namespace: BurnSoft.Applications.MLL.Listings
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Bullets](./burnsoft.applications.mll.listings.bullets)
