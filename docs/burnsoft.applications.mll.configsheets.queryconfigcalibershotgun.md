...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [QueryConfigCaliberShotgun](./burnsoft.applications.mll.configsheets.queryconfigcalibershotgun)
...
```csharp
public QueryConfigCaliberShotgun()
```
