...
{
    /// <summary>
    /// Class ConfigListDataPowderShotGun to work with the Config_List_Powder_Data_SG  
    /// table for shotguns 
    /// </summary>
    public class ConfigListDataPowderShotGun
    {
        ...
        /// The class location
        /// </summary>
        private static string ClassLocation = "BurnSoft.Applications.MLL.ConfigSheets.ConfigListDataPowderShotGun";
            ...
            try
            {
                foreach (DataRow d in dt.Rows)
                {
                    lst.Add(new ConfigListPowderData()
                    {
                        ...
                        PsiMin = Convert.ToDouble(d["PSI_Min"]),
                        PsiMid = Convert.ToDouble(d["PSI_Mid"]),
                        PsiMax = Convert.ToDouble(d["PSI_Max"]),
                        LupMin = Convert.ToDouble(d["LUP_Min"]),
        ...
        {
            string sql = $"Select * from Config_List_Powder_Data_SG order by CLNID ASC";
        ...
        public static long GetId(string databasePath, int ConfigNameId, out string errOut)
        {
            ...
            try
            {
                string sql = $"Select * from Config_List_Powder_Data_SG where CLNID={ConfigNameId}";
        ...
        {
            string sql = $"Select * from Config_List_Powder_Data_SG where id={id}";
            return GetList(databasePath, sql, out errOut);
        }
        /// <summary>
        /// Gets the details.
        ...
        {
            string sql = $"Select * from Config_List_Powder_Data_SG where CLNID={Configid}";
            return GetList(databasePath, sql, out errOut);
        }
        /// <summary>
        ...
        /// <returns>System.Int64.</returns>
        /// <exception cref="System.Exception"></exception>
        public static long GetDefaultPowderId(string databasePath, int configId, out double powderLoad, out string errOut)
        {
            long lAns = 0;
            errOut = "";
            powderLoad = 0;
        ...
        /// <param name="PsiMin">The psi minimum.</param>
        /// <param name="PsiMid">The psi mid.</param>
        /// <param name="PsiMax">The psi maximum.</param>
        /// <param name="LupMin">The lup minimum.</param>
        /// <param name="LupMid">The lup mid.</param>
        /// <param name="LupMax">The lup maximum.</param>
        ...
        public static bool Add(string databasePath, long ConfgNameId, long PowderId, double LoadMin,
            ...
            double PsiMin, double PsiMid, double PsiMax, double LupMin, double LupMid, double LupMax,
            bool isDefault, out string errOut)
        {
            ...
            try
            {
                ...
                string sql = $"INSERT INTO Config_List_Powder_Data_SG(CLNID,PID,Load_Min," +
                    $"Load_Mid,Load_Max,FPS_Min,FPS_Mid,FPS_Max,PSI_Min,PSI_Mid,PSI_Max," +
                    $"LUP_Min,LUP_Mid,LUP_Max,IsPref) VALUES(" +
                    $"{ConfgNameId}, {PowderId}, {LoadMin}, " +
                    $"{LoadMid}, {LoadMax}, {FpsMin}, {FpsMid}, {FpsMax}, {PsiMin}, {PsiMid}, " +
                    $"{PsiMax}, {LupMin}, {LupMid}, {LupMax}, {IsPref})";
        ...
        public static bool Update(string databasePath, long id, long ConfgNameId, long PowderId, double LoadMin,
            double LoadMid, double LoadMax, double FpsMin, double FpsMid, double FpsMax, double PsiMin, 
            double PsiMid, double PsiMax, double LupMin, double LupMid, double LupMax,
            bool isDefault, out string errOut)
        {
            errOut = "";
            bool bAns = false;
            try
            {
                ...
                BSOtherObjects o = new BSOtherObjects();
                int IsPref = isDefault ? 0 : 1;
                string sql = $"UPDATE Config_List_Powder_Data_SG set CLNID={ConfgNameId}," +
                    $"PID={PowderId},Load_Min={LoadMin},Load_Mid={LoadMid}, Load_Max={LoadMax}, " +
                    $"FPS_Min={FpsMin}, FPS_Mid={FpsMid}, FPS_Max={FpsMax},PSI_Min={PsiMin},PSI_Mid={PsiMid}, " +
                    $"PSI_Max={PsiMax}, LUP_Min={LupMin},LUP_Mid={LupMid}, " +
                    $"LUP_Max={LupMax},IsPref={IsPref} where id={id}";
        ...
        public static bool Delete(string databasePath, long id, out string errOut)
        {
            ...
            try
            {
                string sql = $"DELETE from Config_List_Powder_Data_SG where id={id}";
                bAns = Database.Execute(databasePath, sql, out errOut);
            }
            catch (Exception e)
            {
        ...
        public static bool DeleteByConfigId(string databasePath, long id, out string errOut)
        {
            ...
            try
            {
                string sql = $"DELETE from Config_List_Powder_Data_SG where CLNID={id}";
                bAns = Database.Execute(databasePath, sql, out errOut);
            }
            catch (Exception e)
            {
