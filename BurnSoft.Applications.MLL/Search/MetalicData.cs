...
{
    /// <summary>
    /// Class MetalicData handles the data in the Search_Fields table
    /// </summary>
    public class MetalicData
    {
        ...
        /// The class location
        /// </summary>
        private static string ClassLocation = "BurnSoft.Applications.MLL.Search.MetalicData";
        ...
        {
            string sql = $"Select * from Search_Fields where ID={id}";
        ...
        {
            string sql = $"Select * from Search_Fields where dis='{description}'";
            return GetList(databasePath, sql, out errOut);
        }
        /// <summary>
        /// Gets all.
        ...
        {
            string sql = $"Select * from Search_Fields order by dis ASC";
            return GetList(databasePath, sql, out errOut);
        }
        /// <summary>
        /// Gets the list.
            ...
            string columnType, out string errOut)
        {
            ...
            try
            {
                string sql = $"INSERT INTO Search_Fields (dis,colname,cType, sync_lastupdate) " +
            ...
            string columnType, out string errOut)
        {
            ...
            try
            {
                string sql = $"UPDATE Search_Fields set dis='{description}'," +
        ...
        public static bool Delete(string databasePath, long id, out string errOut)
        {
            ...
            try
            {
                string sql = $"DELETE from Search_Fields where id={id}";
                bAns = Database.Execute(databasePath, sql, out errOut);
            }
            catch (Exception e)
            {
