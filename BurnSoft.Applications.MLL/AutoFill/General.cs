...
{
    /// <summary>
    /// Class General auto fille functions
    /// </summary>
    public class General
    {
        ...
        /// The class location
        /// </summary>
        private static string ClassLocation = "BurnSoft.Applications.MLL.AutoFill.General";
        /// <summary>
        ...
        #endregion        
        /// <summary>
        /// Mains the collection.  This is fexiable and is used in the other auto fille function
        /// </summary>
        ...
        public static AutoCompleteStringCollection MainCollection(string databasePath, string strColumn, string strTable, out string errOut, string sql = "")
        {
