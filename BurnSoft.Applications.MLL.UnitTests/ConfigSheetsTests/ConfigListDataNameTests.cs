...
namespace BurnSoft.Applications.MLL.UnitTests.ConfigSheetsTests
{
    ...
    public class ConfigListDataNameTests
    {
        ...
        [TestMethod, TestCategory("Config Sheets - Config Name Data")]
        public void SetActivityTrueTest()
        {
            bool bAns = false;
            try
            {
                ...
                PrintTestConfigNames();
                long id = ConfigListDataName.GetId(_databasePath, _ConfigName, out _);
                bool value = ConfigListDataName.SetActivity(_databasePath, id, true, out _errOut);
                if (_errOut.Length > 0) throw new Exception(_errOut);
                TestContext.WriteLine($"VALUE: {value}");
                PrintTestConfigNames("AFTER");
                bAns = true;
        ...
        [TestMethod, TestCategory("Config Sheets - Config Name Data")]
        public void SetActivityFalseTest()
        {
            bool bAns = false;
            try
            {
                ...
                PrintTestConfigNames();
                long id = ConfigListDataName.GetId(_databasePath, _ConfigName, out _);
                bool value = ConfigListDataName.SetActivity(_databasePath, id, false, out _errOut);
                if (_errOut.Length > 0) throw new Exception(_errOut);
                TestContext.WriteLine($"VALUE: {value}");
                PrintTestConfigNames("AFTER");
                bAns = true;
        ...
        [TestMethod, TestCategory("Config Sheets - Config Name Data")]
        public void SetPersonalTrueTest()
        {
            bool bAns = false;
            try
            {
                ...
                PrintTestConfigNames();
                long id = ConfigListDataName.GetId(_databasePath, _ConfigName, out _);
                bool value = ConfigListDataName.SetPersonal(_databasePath, id, true, out _errOut);
                if (_errOut.Length > 0) throw new Exception(_errOut);
                TestContext.WriteLine($"VALUE: {value}");
                PrintTestConfigNames("AFTER");
                bAns = true;
        ...
        [TestMethod, TestCategory("Config Sheets - Config Name Data")]
        public void SetPersonalFalseTest()
        {
            bool bAns = false;
            try
            {
                ...
                PrintTestConfigNames();
                long id = ConfigListDataName.GetId(_databasePath, _ConfigName, out _);
                bool value = ConfigListDataName.SetPersonal(_databasePath, id, false, out _errOut);
                if (_errOut.Length > 0) throw new Exception(_errOut);
                TestContext.WriteLine($"VALUE: {value}");
                PrintTestConfigNames("AFTER");
                bAns = true;
        ...
        public void UpdateNotesTest()
        {
            ...
            try
            {
                ...
                PrintTestConfigNames();
                long id = ConfigListDataName.GetId(_databasePath, _ConfigName, out _);
                bool value = ConfigListDataName.UpdateNotes(_databasePath, id, "Unit Test update notes Only", out _errOut);
                if (_errOut.Length > 0) throw new Exception(_errOut);
                TestContext.WriteLine($"VALUE: {value}");
                PrintTestConfigNames("AFTER");
                bAns = true;
